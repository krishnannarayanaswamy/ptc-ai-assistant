        ...
        <div className='chatbot-header pb-6'>
          <div className='flex justify-between'>
            <div className='flex items-center gap-2'>
              ...
              <h1 className='chatbot-text-primary text-xl md:text-2xl font-medium'>PTC AI Assistant</h1>
            </div>
          ...
          <p className="chatbot-text-secondary-inverse text-sm md:text-base mt-2 md:mt-4">Welcome to PTC AI assistant! Simply type your questions or requests in a clear and concise manner.</p>
        </div>
